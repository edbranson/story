...
class EntryForm(ModelForm):
    ...
    my_comment      = forms.CharField(required=False, widget=forms.Textarea(attrs={"rows": 3,"cols":40,}),)
    review          = forms.CharField(required=False, widget=forms.Textarea(attrs={"rows": 3,"cols":40}),)
